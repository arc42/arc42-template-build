...
arc42-template/
  ...
  (...other languages)  
  /images/
    ... (PNG/JPG diagrams, partly localized, partly shared across languages)
...
## Inputs and Source Layout

### Primary Inputs

- The `arc42-template` repository with per-language AsciiDoc sources.
- `version.properties` per language.
- Diagram images (PNG/JPG) under a common c `images` directory (that decision might be changed).
- Optional: other templates (e.g., `req42`) that follow a similar structure.
...
| 1        | AsciiDoc (pass-through)        | `.adoc`    |
| 1        | Markdown (single file)         | `.md`      |
| 1        | Markdown (multi-page)          | `.md`      |
| 2        | GitHub Markdown (single file)  | `.md`      |
| 2        | GitHub Markdown (multi-page)   | `.md`      |
